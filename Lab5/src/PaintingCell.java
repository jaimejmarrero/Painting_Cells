...
public class PaintingCell {
     ...
     * Example Usage:
     * <pre>
     *      PaintingCell new_cell = new PaintingCell("blue", true);
     *  </pre>
     * <p>
     * This snippet will create a new cell that prints a blue * when rendered.
     *
     * @param color_name the name of the color to fill in a cell. (Use PaintingCell.colorExists() to test the name.)
     * @param is_visible if true, cell will print as a colored "*". If false, cell will print as blank space.
     */
    public PaintingCell(String color_name, boolean is_visible) {
        this.visibility = is_visible;
        this.changeColor(color_name);
    }
     ...
     *     PaintingCell new_cell = new PaintingCell(color_name, true);
     * </pre>
     * <p>
